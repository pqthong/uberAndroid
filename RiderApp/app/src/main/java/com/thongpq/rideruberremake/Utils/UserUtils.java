package com.thongpq.rideruberremake.Utils;
...
import com.thongpq.rideruberremake.Model.TokenModel;
import com.thongpq.rideruberremake.Service.MyFirebaseMessagingService;

import java.util.Map;

public class UserUtils {
    public static void updateUser(DrawerLayout view, Map<String, Object> updateData) {
